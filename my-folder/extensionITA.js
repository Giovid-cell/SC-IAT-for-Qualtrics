...
define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
    ...
    // ADD THE NEW PROPERTIES RIGHT HERE (right before trialsByBlock)
    // Feedback configuration
    timeoutMessage: 'Por favor responda mais rápido!', // Message to show on timeout
    timeoutMessageDuration: 500, // Duration to show timeout message (ms)
    correctFeedback: 'O', // The green "O" for correct responses
    correctFeedbackDuration: 500, // Duration to show correct feedback (ms)
    ...
    input: [
        ...
        // correct response
        {
            ...
            actions: [
                ...
                {type:'showStim', handle:'correctFeedback'}, // Show green "O"
                {type:'log'},
        ...
        // ⏱ timeout without response = mistake
        {
            ...
            actions: [
                {type:'showStim', handle:'error'},
                {type:'showStim', handle:'timeoutMessage'}, // Show timeout message
                {type:'setTrialAttr', setter:{score:1}},
                {type:'log'},
        ...
        // end trial (after feedback has been shown)
        {
